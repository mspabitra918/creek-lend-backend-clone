...
export async function sendApplicationConfirmationEmail(
      ...
      <div style="border: 1px solid #e5e7eb; border-top: none; padding: 30px; border-radius: 0 0 8px 8px;">
        ...
        <div style="text-align: center; padding: 10px 0;">
          <p style="color: #374151; font-size: 14px; margin: 5px 0;">
            <strong>Phone:</strong> <a href="tel:+17472080334" style="color: #1a56db; text-decoration: none;">(747) 208-0334</a>
          </p>
          <p style="color: #374151; font-size: 14px; margin: 5px 0;">
            <strong>Email:</strong> <a href="mailto:support@brookloans.com" style="color: #1a56db; text-decoration: none;">support@brookloans.com</a>
          </p>
          <p style="color: #374151; font-size: 14px; margin: 5px 0;">
  ...
  await sendMailgunEmail(
    email,
    `Your application is pre-approved. Complete bank verification to continue - ID: ${applicationId} | Brook Loans`,
    html,
  );
}
...
> = {
  ...
  bank_reverification: {
    ...
    <p style="color: #374151; font-size: 16px; margin-bottom: 16px;">If you continue to have trouble or need to connect a different account, call us at <a href="tel:+17472080334" style="color: #1a56db; text-decoration: none;">(747) 208-0334</a>.</p>
    <p style="color: #374151; font-size: 16px;">Best,<br/>Brook Loans Customer Support</p>
  `,
    color: "#dc2626",
    icon: "&#128273;",
  },
    ...
    customBody: (details, formattedAmount) => {
      ...
      return `
        ...
        <p style="color: #374151; font-size: 16px;">
          ...
          <strong>Phone:</strong> <a href="tel:+17472080334" style="color: #1a56db; text-decoration: none;">(747) 208-0334</a><br/>
          <strong>Email:</strong> <a href="mailto:support@brookloans.com" style="color: #1a56db; text-decoration: none;">support@brookloans.com</a>
        </p>
  ...
  declined_pb: {
    ...
    customBody: (details) => `
      ...
      <p style="color: #374151; font-size: 16px;">
        Phone: <a href="tel:+17472080334" style="color: #1a56db; text-decoration: none;">(747) 208-0334</a><br/>
        Email: <a href="mailto:support@brookloans.com" style="color: #1a56db; text-decoration: none;">support@brookloans.com</a>
      </p>
...
export async function sendStatusUpdateEmail(
  ...
  if (status === "funded") {
    ...
    ctaButtonHtml = `
      <div style="text-align: center; margin: 25px 0;">
        <a href="mailto:support@brookloans.com" style="background: #1a56db; color: #ffffff; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-size: 16px; font-weight: bold; display: inline-block;">
          CONTACT SUPPORT
        </a>
      </div>
    `;
...
export async function sendPostBankVerificationEmail(
  ...
  await sendMailgunEmail(
    email,
    `Your bank verification is complete. Call us to complete the next step - ID: ${applicationId} | Brook Loans`,
    html,
  );
}
