...
const statusConfig: Record<string, { title: string; message: string; color: string; icon: string }> = {
  bank_verification_pending: {
    ...
    message: "Your loan application has been received. Please complete the bank verification process to proceed with your application.",
    color: "#f59e0b",
    icon: "&#127974;",
  },
  bank_verification_completed: {
    title: "Bank Verification Completed",
    message: "Your bank verification has been successfully completed. Your application is now being prepared for review by our team.",
    color: "#16a34a",
    icon: "&#9989;",
  },
  reviewing: {
  ...
  approved: {
    ...
    message: "Congratulations! Your loan application has been approved. Our team will be in touch shortly with the next steps to finalize your loan.",
    color: "#16a34a",
    icon: "&#9989;",
  },
  declined: {
    title: "Application Update",
    message: "After careful review, we are unable to approve your loan application at this time. If you have any questions, please don't hesitate to contact our support team.",
    color: "#dc2626",
    icon: "&#10060;",
  },
  funded: {
    title: "Loan Funded!",
    message: "Great news! Your loan has been funded and the funds will be deposited into your bank account. Please allow 1-3 business days for the transfer to complete.",
    color: "#16a34a",
    icon: "&#128176;",
  },
  pending: {
    title: "Application Pending",
    message: "Your application is now pending review. Our team will begin reviewing your application shortly.",
    color: "#f59e0b",
    icon: "&#9203;",
  },
};

export async function sendStatusUpdateEmail(details: StatusUpdateDetails): Promise<void> {
